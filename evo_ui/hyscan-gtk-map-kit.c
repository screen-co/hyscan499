                   ...
                   HyScanGtkMapKit   *kit)
{
  ...
  hyscan_gtk_map_wfmark_layer_mark_highlight (HYSCAN_GTK_MAP_WFMARK_LAYER (priv->wfmark_layer), mark_id);
  hyscan_gtk_map_geomark_layer_mark_highlight (HYSCAN_GTK_MAP_GEOMARK_LAYER (priv->geomark_layer), mark_id);
